import{w as Y,x as K,q as W,y as H,t as Q,r as l,o as e,z as G}from"./chunk-5KNZJZUH-DEhw9y3M.js";import"./types-D0aIzRCm.js";import{b as X}from"./index-DZqwpE7N.js";function Z(t){if(!t)return"—";const n=new Date(t);return Number.isNaN(n.getTime())?"—":n.toLocaleString()}function T(t){switch(t){case"completed":return{label:"Success",tone:"ok"};case"failed":return{label:"Failed",tone:"fail"};case"processing":return{label:"Processing",tone:"pending"};case"queued":return{label:"Queued",tone:"pending"};case"retrying":return{label:"Retrying",tone:"pending"};default:return{label:t,tone:"pending"}}}function ee(t){const n=T(t.status);return{id:t.id,time:Z(t.createdAt),productLabel:t.productId?`Product ${t.productId}`:"Try-on job",status:t.status,statusLabel:n.label,duration:t.processingTimeMs?`${Math.round(t.processingTimeMs/1e3)}s`:void 0,error:t.error||void 0}}const ne=Y(function(){const{shop:n,settings:r,stats:a,usage:v,activity:j,backendStatus:m,backendUrl:A,initialTab:z,isDevAdmin:D}=W(),g=H(),y=Q(),[i,c]=l.useState(z),M="nanobanana",[h,P]=l.useState(r.buttonText||"Try This Dress 👗"),[u,B]=l.useState(r.buttonColor||"#1a1a2e"),[x,L]=l.useState(r.enabled),[N,R]=l.useState(r.watermarkEnabled),[k,I]=l.useState(r.maxDailyRequests||100),[w,E]=l.useState(r.processingMessage||"Our AI is styling you..."),b=g.data,d=l.useMemo(()=>j.map(ee),[j]),$=l.useMemo(()=>[["time","product","status","duration_sec","error"],...d.map(o=>[o.time,o.productLabel,o.statusLabel,o.duration||"",o.error||""])].map(o=>o.map(J=>`"${String(J).replace(/"/g,'""')}"`).join(",")).join(`
...
}`,U={dashboard:"Dashboard",settings:"Settings",install:"Installation Guide",logs:"Activity Logs"},S=()=>{const s=new FormData;s.set("intent","save-settings"),s.set("enabled",x?"on":"off"),s.set("watermarkEnabled",N?"on":"off"),s.set("aiProvider",M),s.set("buttonText",h),s.set("buttonColor",u),s.set("maxDailyRequests",String(k)),s.set("processingMessage",w),g.submit(s,{method:"post"})},V=()=>{const s=new FormData;s.set("intent","reset-settings"),g.submit(s,{method:"post"})},p=s=>{const o=new URLSearchParams(y.search);return o.set("tab",s),`${y.pathname}?${o.toString()}`};return e.jsxs("div",{children:[e.jsx("style",{children:se}),e.jsxs("div",{className:"shell",children:[e.jsxs("aside",{className:"sidebar",children:[e.jsxs("div",{className:"sidebar-logo",children:[e.jsx("h1",{children:"👗 Virtual Try-On"}),e.jsx("p",{children:"Shopify Plugin Admin"}),e.jsx("p",{className:"text-sm text-muted",style:{marginTop:8},children:n})]}),e.jsxs("nav",{className:"sidebar-nav",children:[e.jsxs("a",{className:`nav-item ${i==="dashboard"?"active":""}`,href:p("dashboard"),onClick:s=>{s.preventDefault(),c("dashboard")},children:[e.jsx("span",{className:"icon",children:"📊"})," Dashboard"]}),e.jsxs("a",{className:`nav-item ${i==="settings"?"active":""}`,href:p("settings"),onClick:s=>{s.preventDefault(),c("settings")},children:[e.jsx("span",{className:"icon",children:"⚙️"})," Settings"]}),e.jsxs("a",{className:`nav-item ${i==="install"?"active":""}`,href:p("install"),onClick:s=>{s.preventDefault(),c("install")},children:[e.jsx("span",{className:"icon",children:"🔌"})," Installation"]}),e.jsxs("a",{className:`nav-item ${i==="logs"?"active":""}`,href:p("logs"),onClick:s=>{s.preventDefault(),c("logs")},children:[e.jsx("span",{className:"icon",children:"📋"})," Activity Logs"]}),D?e.jsxs("a",{className:"nav-item",href:"/platform",children:[e.jsx("span",{className:"icon",children:"🛠️"})," Platform Admin"]}):null]}),e.jsx("div",{className:"sidebar-footer",children:"v1.0.0 · AI Try-On Plugin"})]}),e.jsxs("div",{className:"main",children:[e.jsxs("div",{className:"topbar",children:[e.jsx("h2",{children:U[i]}),e.jsxs("div",{className:"topbar-actions",children:[e.jsxs("span",{className:`badge ${x?"badge-green":"badge-red"}`,children:[e.jsx("span",{className:"dot"})," ",x?"Plugin Active":"Plugin Disabled"]}),i==="settings"?e.jsx("button",{className:"btn btn-primary btn-sm",onClick:S,children:"💾 Save Changes"}):null]})]}),e.jsxs("div",{className:"content",children:[i==="dashboard"?e.jsxs("div",{id:"tab-dashboard",children:[b?e.jsx("div",{className:`alert ${b.ok?"alert-success":"alert-error"}`,children:b.message}):null,m==="unreachable"?e.jsx("div",{className:"alert alert-error",children:"⚠ Backend not reachable. Connect backend to sync settings."}):null,m==="unauthorized"?e.jsxs("div",{className:"alert alert-info",children:["ℹ Backend is reachable, but admin API auth failed. Set matching ",e.jsx("code",{style:{fontFamily:"monospace"},children:"API_SECRET"})," for frontend and backend."]}):null,m==="connected"?e.jsxs("div",{className:"alert alert-success",children:["✓ Backend connected at ",A]}):null,e.jsxs("div",{className:"stats-grid",children:[e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-label",children:"Total Try-Ons"}),e.jsx("div",{className:"stat-value",children:a.totalJobs}),e.jsx("div",{className:"stat-change",children:a.totalJobs===0?"No try-ons yet":"Live from backend"})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-label",children:"Success Rate"}),e.jsx("div",{className:"stat-value",children:`${a.successRate}%`}),e.jsx("div",{className:"stat-change",children:a.totalJobs===0?"—":"Live from backend"})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-label",children:"Avg. Processing"}),e.jsx("div",{className:"stat-value",children:a.averageProcessingTimeMs?`${Math.round(a.averageProcessingTimeMs/1e3)}s`:"—"}),e.jsx("div",{className:"stat-change",children:a.totalJobs===0?"—":"Live from backend"})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-label",children:"Failed Jobs"}),e.jsx("div",{className:"stat-value",children:a.failedJobs}),e.jsx("div",{className:"stat-change",children:a.totalJobs===0?"—":"Live from backend"})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-label",children:"Daily Usage"}),e.jsxs("div",{className:"stat-value",children:[v.dailyUsed," / ",a.dailyLimit??r.maxDailyRequests]}),e.jsx("div",{className:"stat-change",children:"Resets daily"})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-label",children:"Monthly Usage"}),e.jsxs("div",{className:"stat-value",children:[v.monthlyUsed," / ",a.monthlyLimit??"—"]}),e.jsx("div",{className:"stat-change",children:"Set by TryAura platform"})]})]}),e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"card-header",children:e.jsxs("div",{children:[e.jsx("div",{className:"card-title",children:"Plugin Controls"}),e.jsx("div",{className:"card-subtitle",children:"Quickly enable or disable features store-wide"})]})}),e.jsxs("div",{className:"toggle-row",children:[e.jsxs("div",{className:"toggle-info",children:[e.jsx("h4",{children:"Virtual Try-On Button"}),e.jsx("p",{children:'Show "Try This Dress" button on all product pages'})]}),e.jsxs("label",{className:"toggle",children:[e.jsx("input",{type:"checkbox",checked:x,onChange:s=>L(s.target.checked)}),e.jsx("span",{className:"toggle-track"})]})]}),e.jsxs("div",{className:"toggle-row",children:[e.jsxs("div",{className:"toggle-info",children:[e.jsx("h4",{children:"Mobile Support"}),e.jsx("p",{children:"Display button and modal on mobile devices"})]}),e.jsxs("label",{className:"toggle",children:[e.jsx("input",{type:"checkbox",defaultChecked:!0}),e.jsx("span",{className:"toggle-track"})]})]}),e.jsxs("div",{className:"toggle-row",children:[e.jsxs("div",{className:"toggle-info",children:[e.jsx("h4",{children:"Download Button"}),e.jsx("p",{children:"Allow customers to download their try-on result"})]}),e.jsxs("label",{className:"toggle",children:[e.jsx("input",{type:"checkbox",defaultChecked:!0}),e.jsx("span",{className:"toggle-track"})]})]}),e.jsxs("div",{className:"toggle-row",children:[e.jsxs("div",{className:"toggle-info",children:[e.jsx("h4",{children:"Result Watermark"}),e.jsx("p",{children:"Add your store name watermark to generated images"})]}),e.jsxs("label",{className:"toggle",children:[e.jsx("input",{type:"checkbox",checked:N,onChange:s=>R(s.target.checked)}),e.jsx("span",{className:"toggle-track"})]})]})]}),e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"card-header",children:[e.jsx("div",{className:"card-title",children:"Recent Activity"}),e.jsx("a",{className:"btn btn-ghost btn-sm",href:p("logs"),onClick:s=>{s.preventDefault(),c("logs")},children:"View All →"})]}),d.length===0?e.jsxs("p",{className:"text-muted text-sm",children:["No try-ons yet for ",n,"."]}):d.slice(0,4).map(s=>e.jsx(C,{log:s,compact:!0},s.id))]})]}):null,i==="settings"?e.jsxs("div",{id:"tab-settings",children:[e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"card-header",children:e.jsxs("div",{children:[e.jsx("div",{className:"card-title",children:"AI Provider"}),e.jsx("div",{className:"card-subtitle",children:"Choose your AI processing backend"})]})}),e.jsx("div",{className:"provider-grid",children:e.jsxs("div",{className:"provider-option selected",children:[e.jsx("div",{className:"provider-check",children:"✓"}),e.jsx("h4",{children:"🍌 Nano Banana Pro"}),e.jsx("p",{children:"Exclusive model · Production quality · Optimized latency"})]})}),e.jsx("p",{className:"text-sm text-muted",style:{marginBottom:16},children:"More models coming soon."}),e.jsxs("div",{className:"form-row",children:[e.jsxs("label",{className:"form-label",children:["API Key ",e.jsx("span",{children:"(stored securely server-side)"})]}),e.jsx("input",{type:"text",placeholder:"Enter your Nano Banana Pro API key"})]}),e.jsxs("div",{className:"alert alert-info",style:{marginBottom:0},children:["ℹ API keys are stored in your backend ",e.jsx("code",{style:{fontFamily:"monospace"},children:".env"})," file and never exposed to the browser."]})]}),e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"card-header",children:e.jsx("div",{className:"card-title",children:"Button Appearance"})}),e.jsxs("div",{className:"form-grid-2",children:[e.jsxs("div",{className:"form-row",style:{marginBottom:0},children:[e.jsx("label",{className:"form-label",children:"Button Label"}),e.jsx("input",{type:"text",value:h,onChange:s=>P(s.target.value)})]}),e.jsxs("div",{className:"form-row",style:{marginBottom:0},children:[e.jsx("label",{className:"form-label",children:"Button Colour"}),e.jsx("input",{type:"color",value:u,onChange:s=>B(s.target.value)})]})]}),e.jsx("div",{className:"mt-2 text-sm text-muted",children:"Preview:"}),e.jsx("div",{style:{marginTop:10},children:e.jsx("button",{id:"btn-preview",style:{display:"inline-flex",alignItems:"center",gap:8,padding:"12px 24px",background:u,color:"#fff",border:"none",borderRadius:8,fontSize:15,fontWeight:600,cursor:"default",fontFamily:"inherit"},children:h})})]}),e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"card-header",children:e.jsx("div",{className:"card-title",children:"Limits & Messages"})}),e.jsxs("div",{className:"form-grid-2",children:[e.jsxs("div",{className:"form-row",children:[e.jsx("label",{className:"form-label",children:"Max Daily Requests"}),e.jsx("input",{type:"number",value:k,onChange:s=>I(Number(s.target.value)),min:1,max:1e4})]}),e.jsxs("div",{className:"form-row",children:[e.jsx("label",{className:"form-label",children:"Max File Size (MB)"}),e.jsx("input",{type:"number",defaultValue:10,min:1,max:20})]})]}),e.jsxs("div",{className:"form-row",children:[e.jsxs("label",{className:"form-label",children:["Processing Message ",e.jsx("span",{children:"(shown while AI works)"})]}),e.jsx("input",{type:"text",value:w,onChange:s=>E(s.target.value)})]}),e.jsxs("div",{className:"form-row",style:{marginBottom:0},children:[e.jsxs("label",{className:"form-label",children:["Error Message ",e.jsx("span",{children:"(shown on failure)"})]}),e.jsx("input",{type:"text",defaultValue:"Something went wrong. Please try a clearer photo."})]})]}),e.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:10},children:[e.jsx("button",{className:"btn btn-ghost",onClick:V,children:"Reset to Defaults"}),e.jsx("button",{className:"btn btn-primary",onClick:S,children:"💾 Save Settings"})]})]}):null,i==="install"?e.jsxs("div",{id:"tab-install",children:[e.jsx("div",{className:"alert alert-info",children:"📌 Follow these steps to add the Virtual Try-On plugin to your Shopify theme."}),e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"card-title",style:{marginBottom:16},children:"Step 1 — Upload the Plugin File"}),e.jsxs("p",{className:"text-sm text-muted",style:{marginBottom:14},children:["In your Shopify admin, go to ",e.jsx("strong",{children:"Online Store → Themes → Actions → Edit Code"}),". Under ",e.jsx("strong",{children:"Assets"}),", upload the file ",e.jsx("code",{style:{fontFamily:"monospace"},children:"tryon-widget.js"}),"."]}),e.jsx("p",{className:"text-sm text-muted",children:"You can download the latest plugin file here:"}),e.jsx("div",{style:{marginTop:12},children:e.jsx("a",{href:"/tryon-widget.js",download:!0,className:"btn btn-primary",children:"⬇ Download tryon-widget.js"})})]}),e.jsx(f,{title:"Step 2 — Add the Liquid Snippet",text:"Create a new snippet called tryon-button.liquid and paste this code:",code:q}),e.jsx(f,{title:"Step 3 — Render in Product Template",text:"In your product template (e.g. sections/main-product.liquid), add this line just after your Add-to-Cart button block:",code:F}),e.jsx(f,{title:"Step 4 — Configure Theme Settings",text:"Add these settings to your config/settings_schema.json:",code:O})]}):null,i==="logs"?e.jsx("div",{id:"tab-logs",children:e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"card-header",children:[e.jsx("div",{className:"card-title",children:"Activity Log"}),e.jsx("a",{className:"btn btn-ghost btn-sm",href:_,download:"tryon-activity.csv",children:"⬇ Export CSV"})]}),e.jsx("div",{children:d.length===0?e.jsxs("p",{className:"text-muted text-sm",children:["No activity for ",n," yet."]}):d.map(s=>e.jsx(C,{log:s},s.id))})]})}):null]})]})]})]})});function C({log:t,compact:n=!1}){const r=T(t.status).tone,a=r==="ok"?"badge-green":r==="fail"?"badge-red":"badge-amber";return e.jsxs("div",{className:"log-row",children:[e.jsx("div",{className:`log-status ${r}`}),e.jsxs("div",{style:{flex:1},children:[e.jsxs("div",{children:[e.jsx("strong",{children:t.productLabel}),!n&&t.error?e.jsxs(e.Fragment,{children:[" — ",t.error]}):null]}),e.jsxs("div",{className:"log-meta",children:[t.time,t.duration?` · ${t.duration}`:""]}),n&&t.error?e.jsx("div",{className:"text-sm",style:{color:"var(--red)"},children:t.error}):null]}),e.jsx("span",{className:`badge ${a}`,children:t.statusLabel})]})}function f({title:t,text:n,code:r}){const a=async()=>{await navigator.clipboard.writeText(r)};return e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"card-title",style:{marginBottom:16},children:t}),e.jsx("p",{className:"text-sm text-muted",style:{marginBottom:14},children:n}),e.jsxs("div",{className:"code-block",style:{position:"relative"},children:[e.jsx("button",{className:"copy-btn",onClick:a,children:"Copy"}),e.jsx("pre",{children:r})]})]})}const se=`
...
`,ie=K(function(){return X.error(G())});export{ie as ErrorBoundary,ne as default};
