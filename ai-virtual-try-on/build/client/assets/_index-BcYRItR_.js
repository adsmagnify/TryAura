import{w as Y,x as K,q as W,y as H,t as Q,r as l,o as e,z as G,A as X}from"./chunk-5KNZJZUH-C21ORtGP.js";import"./types-D0aIzRCm.js";import{b as Z}from"./index-CR7vH6Gl.js";function ee(t){if(!t)return"—";const n=new Date(t);return Number.isNaN(n.getTime())?"—":n.toLocaleString()}function A(t){switch(t){case"completed":return{label:"Success",tone:"ok"};case"failed":return{label:"Failed",tone:"fail"};case"processing":return{label:"Processing",tone:"pending"};case"queued":return{label:"Queued",tone:"pending"};case"retrying":return{label:"Retrying",tone:"pending"};default:return{label:t,tone:"pending"}}}function se(t){const n=A(t.status);return{id:t.id,time:ee(t.createdAt),productLabel:t.productId?`Product ${t.productId}`:"Try-on job",status:t.status,statusLabel:n.label,duration:t.processingTimeMs?`${Math.round(t.processingTimeMs/1e3)}s`:void 0,error:t.error||void 0}}const ie=Y(function(){const{shop:n,settings:r,stats:a,usage:v,activity:j,backendStatus:m,backendUrl:T,initialTab:z,isDevAdmin:D}=W(),g=H(),y=Q(),[i,c]=l.useState(z),M="nanobanana",[h,P]=l.useState(r.buttonText||"Try This Dress 👗"),[u,B]=l.useState(r.buttonColor||"#1a1a2e"),[x,L]=l.useState(r.enabled),[N,R]=l.useState(r.watermarkEnabled),[k,I]=l.useState(r.maxDailyRequests||100),[w,E]=l.useState(r.processingMessage||"Our AI is styling you..."),b=g.data,d=l.useMemo(()=>j.map(se),[j]),$=l.useMemo(()=>[["time","product","status","duration_sec","error"],...d.map(o=>[o.time,o.productLabel,o.statusLabel,o.duration||"",o.error||""])].map(o=>o.map(J=>`"${String(J).replace(/"/g,'""')}"`).join(",")).join(`
